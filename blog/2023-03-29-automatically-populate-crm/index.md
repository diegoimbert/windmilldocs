...
- Resources: chances are high that your CRM is not Airtable. Use other scripts ([Hubspot](https://hub.windmill.dev/?app=hubspot), [Gsheet](https://hub.windmill.dev/?app=gsheets), update data on [Supabase etc.](https://hub.windmill.dev/?app=supabase)). [Create a resource type](/docs/core_concepts/resources_and_types#create-a-resource-type). Or [ask us what you need](/docs/misc/getting_help).
