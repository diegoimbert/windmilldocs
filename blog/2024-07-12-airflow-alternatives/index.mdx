...
![Dagster Global Asset Lineage](https://docs.dagster.io/assets/images/exampleco-global-asset-lineage-1dd2bc3b65f549cba1445462f73d3ac7.png "Dagster Global Asset Lineage")
> Dagster Global Asset Lineage ([source](hhttps://docs.dagster.io/guides/build/assets/asset-selection-syntax/examples))
...
![Kedro graphs](https://raw.githubusercontent.com/kedro-org/kedro-viz/main/banner.gif "Kedro graphs")
> Kedro graphs ([source](https://raw.githubusercontent.com/kedro-org/kedro-viz/main/banner.gif))
...
<div className="flex  justify-center !rounded-2xl overflow-hidden">
    <object data="/use_cases.svg" type="image/svg+xml" className="scaled-svg" style={{ width: '90%', height: '90%' }} aria-label="Windmill use cases diagram" />
</div>
