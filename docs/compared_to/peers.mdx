...
description: What are the alternatives to Windmill for workflow orchestration, internal tools, and scripting?
---
...
examples: _[Temporal](/compare/temporal)_, _[Airflow](/compare/airflow)_, _[Prefect](/docs/compared_to/prefect)_, _Dagster_, _[Hatchet](/docs/compared_to/peers#hatchet)_
...
For a detailed comparison, see our [Kestra comparison page](/docs/compared_to/kestra) or the interactive [Windmill vs Kestra](/compare/kestra) side-by-side.
...
- **Enterprise-ready**: Advanced features like [DuckLake integration](../core_concepts/11_persistent_storage/ducklake.mdx), [customer portal](../misc/7_plans_details/index.mdx#windmill-customer-portal), [autoscaling](../core_concepts/42_autoscaling/index.mdx), and comprehensive [monitoring](../core_concepts/5_monitor_past_and_future_runs/index.mdx)
...
- **Data capabilities**: [DuckLake integration](../core_concepts/11_persistent_storage/ducklake.mdx) for data lake management, [DuckDB support](../integrations/duckdb.md), and improved [data pipeline orchestration](../core_concepts/27_data_pipelines//index.mdx)
