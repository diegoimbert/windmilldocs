---
description: How do I build an internal tool with Windmill? Create data-driven apps and dashboards with drag-and-drop components and code.
---

import DocCard from '@site/src/components/DocCard';
import { useColorMode } from '@docusaurus/theme-common';

# Apps quickstart (low-code)
...
<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		...
		description="Prefer React or Svelte? Build full-code apps connected to Windmill backend runnables and data tables."
