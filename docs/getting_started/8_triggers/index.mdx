---
description: How do I trigger scripts and flows in Windmill? Use schedules, webhooks, emails, HTTP routes, websockets, Kafka, Postgres, NATS, SQS, MQTT, GCP, Azure Event Grid and more.
---
...
- [Full-code apps](#full-code-apps)
- [Customized UIs with the low-code app editor (legacy)](#customized-uis-with-the-low-code-app-editor-legacy)
...
- [Azure Event Grid triggers](#azure-event-grid-triggers)
...
### Customized UIs with the low-code app editor (legacy)

Windmill also provides a legacy WYSIWYG low-code app editor. It allows you to build your own UI with drag-and-drop components and to connect your data to scripts and flows in minutes. For new apps, we recommend [full-code apps](#full-code-apps) instead.
...
<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		title="Low-code app editor (legacy)"
		color="orange"
		description="Detailed section on Windmill's low-code app editor."
...
For full control over your UI, build [full-code apps](../../full_code_apps/index.mdx) with React or Svelte. Your frontend calls backend runnables that run on Windmill workers, giving you framework-level flexibility while keeping Windmill's execution, permissions and logging.

![Full-code app demo](../9_full_code_apps_quickstart/full_code_app_demo.png 'Full-code app demo')
...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		...
		color="orange"
		description="Step-by-step guide to create your first full-code app."
