...
Calculation: 2 workers × 1 CU each + 1 native worker with 8 subworkers = 3 CUs
...
services:
  ...
  windmill_worker_native:
    deploy:
      replicas: 1  # 1 native worker with 8 subworkers = 1 CU
      resources:
        limits:
          memory: 2048M
    environment:
...
Calculation: 3 workers × 1 CU each + 1 native worker with 8 subworkers = 8 CUs
...
Calculation: 2 workers × 1 CU each + 4 workers × 3 CUs each + 1 native worker with 8 subworkers = 16 CUs
...
Calculation: 2 workers × 1 CU each + 4 workers × 2 CUs each + 1 native worker with 8 subworkers = 12 CUs
