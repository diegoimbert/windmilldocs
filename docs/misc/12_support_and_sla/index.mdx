...
1. Have your Teams admin install the Windmill Support app to a channel from the Microsoft Teams Store. Until publication completes, contact us for a sideloadable `.zip` package.
