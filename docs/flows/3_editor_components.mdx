---
description: What are the main components of the Windmill flow editor (toolbar, settings, inputs, actions)?
---
...
- **Selection/Pan mode toggle**: switch between selection mode (to select multiple nodes, for example to create a [flow group](./1_flow_editor.mdx#flow-groups)) and pan mode for navigation.
...
- **Autosave indicator**: shows the [draft](../core_concepts/0_draft_and_deploy/index.mdx) save status. Drafts are automatically saved as you edit.
...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		...
		href="/docs/core_concepts/persistent_storage/states_resources_shared_directory#shared-directory"
	/>
</div>
