---
description: How do I connect Snowflake to Windmill? Query and manage Snowflake data warehouses from scripts and flows.
---
...
To integrate [Snowflake](https://www.snowflake.com/en/) with Windmill, you can either [create and OAuth connection](../misc/2_setup_oauth/index.mdx#snowflake) or you need to gather the following information and save it as a [resource](../core_concepts/3_resources_and_types/index.mdx).
...
Find some pre-set interactions with Snowflake on the [Hub](https://hub.windmill.dev/?app=snowflake).
