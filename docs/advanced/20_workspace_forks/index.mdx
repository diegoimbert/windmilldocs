...
On [Windmill Cloud](https://app.windmill.dev/), forking is available for workspaces on a paid (Team or Enterprise) plan. Free-tier workspaces cannot create forks - upgrade the workspace to a paid plan first (see [plans & how to upgrade](../../misc/7_plans_details/index.mdx#upgrading-to-team-edition)).
...
Workspace forks do not copy over triggers when being created. This avoids unnecessary executions or confusing collitions. However, you can still create triggers on your fork to test something, and the merge UI will remind you which ones have been created so that you can manually deploy them and/or disable them or delete them.
