...
On [Enterprise Edition](/pricing), telemetry is required for [license compliance](../../misc/19_enterprise_onboarding/index.mdx#billing) and cannot be fully disabled. You can toggle "Minimal telemetry" to reduce the data sent to only what is needed for license compliance.
