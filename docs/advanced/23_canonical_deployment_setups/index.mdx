...
- **Stage 2** relies on [workspace forks](../20_workspace_forks/index.mdx) and [protection rulesets](../../core_concepts/56_protection_rulesets/index.mdx). Forks are available on all self-hosted editions but count toward the global 3-workspace limit on Community Edition. On [Windmill Cloud](https://app.windmill.dev/), forks require a [paid plan](../20_workspace_forks/index.mdx#forks-on-windmill-cloud).
