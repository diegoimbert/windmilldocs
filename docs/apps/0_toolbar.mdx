---
description: How do I use the toolbar in Windmill apps? Configure app settings, undo/redo actions, adjust width and preview modes.
---
...
Send a PDF or PNG preview of any app at a given [schedule](../core_concepts/1_scheduling/index.mdx).
...
Visualize changes between your [current draft](../core_concepts/0_draft_and_deploy/index.mdx#draft) and the [latest deployed version](../core_concepts/0_draft_and_deploy/index.mdx#deployed-version).
...
<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		...
		description="Debug your Windmill apps."
		href="/docs/apps/troubleshoot_panel"
		color="orange"
	/>
</div>
...
Apps are automatically [saved as drafts](./6_app_deployment.mdx) as you edit. The autosave indicator in the toolbar shows the current save status. The first time you save the app, you'll be asked to select the owner of the app. You can choose either a user or a [folder](../core_concepts/8_groups_and_folders/index.mdx#folders).
