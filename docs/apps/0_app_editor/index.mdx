---
description: How do I build apps with the legacy low-code app editor in Windmill? Drag-and-drop components, custom CSS and React components. For new apps, use full-code apps.
---
...
<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		color="orange"
		title="Apps quickstart (low-code)"
		description="Learn how to build your first low-code app in a matter of minutes."
