---
description: How do I use Postgres databases like Supabase or Neon.tech for structured SQL data in Windmill?
---
...
You can find examples and premade Supabase scripts on [Windmill Hub](https://hub.windmill.dev/?app=supabase).
...
From Windmill's [low-code app editor](../../apps/0_app_editor/index.mdx) (legacy), you can use the [Database studio](../../apps/4_app_configuration_settings/database_studio.mdx) component to visualize and manage your databases ([PostgreSQL](../../getting_started/0_scripts_quickstart/5_sql_quickstart/index.mdx#postgresql) / [MySQL](../../getting_started/0_scripts_quickstart/5_sql_quickstart/index.mdx#mysql) / [MS SQL](../../getting_started/0_scripts_quickstart/5_sql_quickstart/index.mdx#ms-sql) / [Snowflake](../../getting_started/0_scripts_quickstart/5_sql_quickstart/index.mdx#snowflake) / [BigQuery](../../getting_started/0_scripts_quickstart/5_sql_quickstart/index.mdx#bigquery)).
