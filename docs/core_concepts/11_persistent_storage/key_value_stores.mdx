---
description: How do I use NoSQL and key-value stores like MongoDB, Redis, and Upstash with Windmill?
---
...
You can find examples and premade MonggoDB scripts on [Windmill Hub](https://hub.windmill.dev/?app=mongodb).
