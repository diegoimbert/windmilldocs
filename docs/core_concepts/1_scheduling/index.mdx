---
description: How do I schedule scripts in Windmill? Use CRON-like syntax with a visual interface and control panels for recurring jobs.
---
...
Cron jobs are one of many ways to [trigger workflows](../../getting_started/8_triggers/index.mdx) in Windmill (among [webhooks](../4_webhooks/index.mdx), [auto-generated UIs](../6_auto_generated_uis/index.mdx), [customized UIs][apps], [full-code apps](../../full_code_apps/index.mdx), [Command-line interface](../../advanced/3_cli/index.mdx), [Slackbots](/blog/handler-slack-commands) etc.)
...
Send a PDF or PNG preview of any [low-code app](../../apps/0_app_editor/index.mdx) (legacy) at a given schedule.
