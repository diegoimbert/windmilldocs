...
-- trigger all
-- partitioned daily
-- materialize ducklake://lake/enriched

-- `{partition}` in the input paths is substituted at run time; the AND barrier
-- guarantees both partition-bearing inputs exist for this partition. The
