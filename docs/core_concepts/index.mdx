---
description: What are Windmill's core concepts? Triggers, scheduling, webhooks, resources, variables, permissions, error handling and more.
---
...
On top of its editors to build endpoints, flows, [low-code apps](../apps/0_app_editor/index.mdx) and [full-code apps](../full_code_apps/index.mdx), Windmill comes with a set of features.
...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		...
		description="Trigger scripts and flows from Azure Event Grid events."
		href="/docs/core_concepts/azure_triggers"
	/>
	<DocCard
...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		...
		description="Write distributed workflows in TypeScript or Python with checkpoint-based orchestration, parallel execution, and fault tolerance."
	...
	/>
	<DocCard
		title="Pipelines (alpha)"
		description="The recommended model for data pipelines: DuckDB steps that materialize into DuckLake, wired by asset lineage, with partitions, joins, data tests and backfill."
		href="/docs/core_concepts/pipelines"
	/>
	<DocCard
		title="ETL & data processing"
		description="The underlying data-processing recipes: efficient S3 streaming, DuckDB connection settings, and single-node benchmarks."
	...
	<DocCard
		title="Streaming"
		description="Stream job results via SSE, webhooks and HTTP routes."
		href="/docs/core_concepts/streaming"
	/>
	<DocCard
		title="Jobs runs"
...
<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		...
		description="Manage Windmill instance configuration declaratively with YAML files or a Kubernetes operator."
		href="/docs/core_concepts/infrastructure_as_code"
	/>
	<DocCard
		title="Self-host"
	...
	<DocCard
		...
		description="Build apps with React or Svelte connected to Windmill backend runnables."
...
## Full-code app features

Build custom frontends with React or Svelte, connected to Windmill backend runnables and [data tables](../core_concepts/11_persistent_storage/data_tables.mdx). See the [full-code app section](../full_code_apps/index.mdx).
...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		...
		description="Define backend scripts in any language, called from your frontend code."
...
## Low-code app features (legacy)

The low-code app editor is legacy. For new apps, we recommend [full-code apps](../full_code_apps/index.mdx) with React or Svelte. All details on low-code apps can be found in the [low-code app editor section](../apps/0_app_editor/index.mdx).
...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		...
		description="Enforce governance policies on workspace changes to make more robust deployment workflows"
