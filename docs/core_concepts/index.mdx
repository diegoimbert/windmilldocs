...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		...
		description="Efficient ETL recipes: S3 streaming, Polars and DuckDB, SQL-to-S3, assembled in the flow editor."
		href="/docs/core_concepts/data_pipelines"
	/>
	<DocCard
		title="Pipelines (alpha)"
		description="Connect scripts into a pipeline via asset lineage, with schedules, partitions, joins and debounce."
