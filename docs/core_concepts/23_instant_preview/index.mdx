---
description: How do I preview and test scripts, flows, and apps directly from the Windmill editor?
---
...
On top of its integrated editors ([scripts](../../script_editor/index.mdx), [flows](../../flows/1_flow_editor.mdx), [low-code apps](../../apps/0_app_editor/index.mdx), [full-code apps](../../full_code_apps/index.mdx)), Windmill allows users to see and test what they are building directly from the editor, even before deployment.
...
The low-code app editor has several methods of previewing results instantly. For full-code apps, see the [UI editor](../../full_code_apps/6_ui_editor/index.mdx) which provides live preview of your React or Svelte frontend, or use `wmill app dev` for local hot reload.
...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	/>
	<DocCard
		title="Full-code apps UI editor"
		description="Edit full-code apps in the browser with live preview."
