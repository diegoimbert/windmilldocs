# Data Processing Addendum for Windmill Cloud Team Plan
...
1. **Definitions**.
   ...
   17. "**UK Addendum**" means the addendum to the Standard Contractual Clauses issued by the UK Information Commissioner under Section 119A(1) of the UK Data Protection Act 2018 (version B1.0, in force March 21, 2022), available at: [https://ico.org.uk/media2/migrated/4019539/international-data-transfer-addendum.pdf](https://ico.org.uk/media2/migrated/4019539/international-data-transfer-addendum.pdf).
   18. "**U.S. State Privacy Laws**" means, collectively, all U.S. state privacy laws and their implementing regulations, as amended or superseded from time to time, that apply generally to the processing of individuals' Personal Data and that do not apply solely to specific industry sectors (e.g., financial institutions), specific demographics (e.g., children), or specific classes of information (e.g., health or biometric information). State Privacy Laws include the following:
       ...
       4. Utah Consumer Privacy Act (Utah Code Ann. §§ 13-61-101 to 13-61-404) ("UCPA"); and (v) Virginia Consumer Data Protection Act (Virginia Code Ann. §§ 59.1-575 to 59.1-585) ("VCDPA").
...
**Measures for ensuring system configuration, including default configuration** Windmill Technologies manages all deployments through automated, repeatable processes driven by infrastructure as code tooling.
...
1. Amazon AWS. Address: 440 Terry Ave N, Seattle, WA 98109. Description: Infrastructure and hosting services. [Data Processing Addendum](https://docs.aws.amazon.com/whitepapers/latest/navigating-gdpr-compliance/aws-data-processing-addendum-dpa.html)
   
2. Grafana Cloud. Address: 44 Tehama St, San Francisco, CA 94105. Description: Monitoring and observability services. [Data Processing Addendum](https://grafana.com/legal/data-processing-agreement/)
   
3. Cloudflare. Address: 101 Townsend St, San Francisco, CA 94107. Description: Content delivery network and security services. [Data Processing Addendum](https://www.cloudflare.com/cloudflare-customer-dpa/)
